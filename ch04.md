...
![图4-1私钥、公钥和比特币地址之间的关系](images/mbc2_0401.png)
...
![图4-2椭圆曲线的示例](images/mbc2_0402.png)
...
![图4-3：椭圆曲线密码学F(p)上的椭圆曲线，其中p = 17](images/mbc2_0403.png)
...
![图4-4曲线上 G、2G、4G 的几何操作](images/mbc2_0404.png)
...
![图4-5从公钥生成比特币地址](images/mbc2_0405.png)
...
![图4-6Base58Check编码的过程](images/mbc2_0406.png)
...
P2SH地址从交易脚本中创建，后者定义谁能花费这个交易输出（参见[【7.3 P2SH（Pay-to-Script-Hash】](ch07.md#73-p2shpay-to-script-hash)）。对P2SH地址编码使用的是与创建比特币地址同样的双重哈希函数，只是应用在脚本而不是公钥：
...
![图4-8展示了通过bitaddress.org 生成的纸钱包](images/mbc2_0408.png)
...
![图4-9展示了通过bitaddress.org 生成的加密纸钱包，密码：test](images/mbc2_0409.png)
...
![图4-10 通过bitcoinpaperwallet.com生成的、私钥写在折叠袋上的纸钱包](images/mbc2_0410.png)
图4-10 从bitcoinpaperwallet.com生成的、私钥写在折叠袋上的纸钱包


![图4-11 通过bitcoinpaperwallet.com 生成的、私钥被密封住的纸钱包](images/mbc2_0411.png)
...
![图4-12 在备份“存根”上有多个私钥副本的纸钱包](images/mbc2_0412.png)
